...
const AppointmentSchema = new mongoose.Schema(
  {
    ...
    // 🟢 UPDATED: Self-initializing administrative block parameters
    adminRequest: {
      requestType: {
        type: String,
        enum: ["Cancel", "Shift", "None"],
        default: "None", // Prevents undefined breaks in DB queries
      },
      ...
      status: {
        ...
        default: "None", // Guarantees an initial placeholder string exists
      },
