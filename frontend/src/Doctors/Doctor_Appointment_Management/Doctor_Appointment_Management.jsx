...
import data from "../../Assets/Data/Appointments_Data.json";
import patientDetails from "../../Assets/Data/Patients_Data.json";
import {
...
// Helper: Convert 12h format to 24h for time calculations
            ...
            {!isDetailView ? (
                ...
                <div className="doc_apt_m_detail_view">
                    ...
                    <div className="doc_apt_m_grid_layout">
                        ...
                        {/* Observation and Prescription Section */}
