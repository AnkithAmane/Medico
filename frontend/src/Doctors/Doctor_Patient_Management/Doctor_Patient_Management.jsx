...
import patientPhoto from "../../Assets/Images/Doctor/default_doctor_pic.png";
...
export default function Patients() {
  ...
  // Filter logic for specific doctor registry
  ...
  return (
    <div className="doc_patn_m_root doc_patn_m_page_fade_in">
      {!isDetailView ? (
        ...
        // Electronic Health Record Workspace
        <div className="doc_patn_m_patient_workspace doc_patn_m_page_fade_in">
          ...
          <div className="doc_patn_m_bento_workspace_grid">
            ...
            {/* Global Hospital Timeline Sidebar */}
