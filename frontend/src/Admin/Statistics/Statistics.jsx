            ...
            <div className="admin_stat_m_bento_row_sync">
              <div className="admin_stat_m_bento_item span_2">
                ...
                <div className="admin_stat_m_canvas_holder_reduced">
                  <Line data={patientCharts.acquisition} options={{ responsive: true, maintainAspectRatio: false, resizeDelay: 200 }} />
                </div>
              </div>
              <div className="admin_stat_m_bento_item">
                ...
                <div className="admin_stat_m_patient_center_content">
                  <div className="admin_stat_m_chart_focus_mini">
                    <Doughnut data={patientCharts.demographics} options={{ cutout: '75%', responsive: true, maintainAspectRatio: false, resizeDelay: 200, plugins: { legend: { display: false } } }} />
                  </div>
                </div>
            ...
            <div className="admin_stat_m_bento_row_sync">
              <div className="admin_stat_m_bento_item span_2">
                ...
                <div className="admin_stat_m_canvas_holder_compact">
                  <Bar data={patientCharts.frequency} options={{ responsive: true, maintainAspectRatio: false, resizeDelay: 200 }} />
                </div>
              </div>
              <div className="admin_stat_m_bento_item">
          ...
          <>
            <div className="admin_stat_m_bento_row_sync">
              <div className="admin_stat_m_bento_item span_2">
                ...
                <div className="admin_stat_m_canvas_holder_reduced">
                  <Line data={doctorCharts.workload} options={{ responsive: true, maintainAspectRatio: false, resizeDelay: 200 }} />
                </div>
              </div>
              <div className="admin_stat_m_bento_item">
                ...
                <div className="admin_stat_m_patient_center_content">
                  <div className="admin_stat_m_chart_focus_mini">
                    <Doughnut data={doctorCharts.specialty} options={{ cutout: '75%', responsive: true, maintainAspectRatio: false, resizeDelay: 200, plugins: { legend: { display: false } } }} />
                  </div>
                </div>
            ...
            <div className="admin_stat_m_bento_row_sync">
              <div className="admin_stat_m_bento_item span_3">
                ...
                <div className="admin_stat_m_canvas_holder_compact">
                  <Bar data={doctorCharts.appointmentsTrend} options={{ responsive: true, maintainAspectRatio: false, resizeDelay: 200, indexAxis: 'y' }} />
                </div>
              </div>
              <div className="admin_stat_m_bento_item">
          ...
          <>
            <div className="admin_stat_m_bento_row_equal">
              <div className="admin_stat_m_bento_item">
                ...
                <div className="admin_stat_m_canvas_holder_reduced">
                  <Bar data={appointmentCharts.volume} options={{ responsive: true, maintainAspectRatio: false, resizeDelay: 200 }} />
                </div>
              </div>
              <div className="admin_stat_m_bento_item">
                <div className="admin_stat_m_card_head">
                ...
                <div className="admin_stat_m_canvas_holder_reduced">
                  <Line data={appointmentCharts.peak} options={{ responsive: true, maintainAspectRatio: false, resizeDelay: 200 }} />
                </div>
              </div>
            </div>
            <div className="admin_stat_m_bento_row_sync">
              <div className="admin_stat_m_bento_item span_2">
                ...
                <div className="admin_stat_m_canvas_holder_compact">
                  <Bar
                    ...
                    options={{ responsive: true, maintainAspectRatio: false, resizeDelay: 200, plugins: { legend: { display: false } } }}
                  />
                </div>
              </div>
              <div className="admin_stat_m_bento_item">
                ...
                <div className="admin_stat_m_canvas_holder_compact">
                  <Doughnut data={appointmentCharts.statusMix} options={{ responsive: true, maintainAspectRatio: false, resizeDelay: 200, plugins: { legend: { position: 'bottom' } } }} />
                </div>
              </div>
            </div>
          </>
