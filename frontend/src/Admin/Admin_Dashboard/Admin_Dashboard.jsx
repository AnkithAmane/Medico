        ...
        <div className="admin_dashboard_right-column">
          ...
          <div className="admin_dashboard_events-section">
            <div className="admin_dashboard_modern-header">
              ...
              <button className="admin_dashboard_text-btn" onClick={() => navigate("/admin/events_management")}>View All</button>
            </div>
            <div className="admin_dashboard_events-list">
              <div className="admin_dashboard_event-card admin_dashboard_pink" onClick={() => navigate("/admin/events_management")}>
              ...
              <div className="admin_dashboard_event-card admin_dashboard_blue" onClick={() => navigate("/admin/events_management")}>
              ...
              <div className="admin_dashboard_event-card" onClick={() => navigate("/admin/events_management")}>
      ...
      <div className="admin_dashboard_bottom-section">
        ...
        <div className="admin_dashboard_info-card-modern">
          <div className="admin_dashboard_modern-header">
            ...
            <button className="admin_dashboard_text-btn" onClick={() => navigate("/admin/doctors_management")}>View All</button>
          </div>
          <div className="admin_dashboard_modern-grid">
            {doctorsData.slice(0, 3).map((doc) => (
              <div className="admin_dashboard_modern-item-card" key={doc.id} onClick={() => navigate("/admin/doctors_management")}>
        ...
        <div className="admin_dashboard_info-card-modern">
          <div className="admin_dashboard_modern-header">
            ...
            <button className="admin_dashboard_text-btn" onClick={() => navigate("/admin/appointments_management")}>Schedule</button>
          </div>
          <div className="admin_dashboard_modern-grid">
            {appointmentsData.slice(0, 3).map((app) => (
              <div className="admin_dashboard_modern-item-card" key={app.id} onClick={() => navigate("/admin/appointments_management")}>
                <div className="admin_dashboard_item-main">
