...
export default function Normal_Stats() {
  ...
  // --- 4. PATIENT SEGMENTATION LOGIC ---
  const patientCharts = useMemo(() => {
    const demoData = patDemoFilter === "Age" 
      ? [
          patientsData.filter(p => p.age <= 18).length,
          patientsData.filter(p => p.age > 18 && p.age <= 35).length,
          patientsData.filter(p => p.age > 35 && p.age <= 50).length,
          patientsData.filter(p => p.age > 50).length,
        ] 
      : [
    ...
    return {
      ...
      ratingDistribution: [
        { star: 5, count: 840, pct: 75 }, { star: 4, count: 120, pct: 15 }, { star: 3, count: 50, pct: 6 }, { star: 2, count: 10, pct: 3 }, { star: 1, count: 4, pct: 1 },
      ]
    };
  }, [patAcqYear, patDemoFilter]);

  // --- 5. DOCTOR WORKLOAD LOGIC ---
    ...
    <div className="sa_revenue_wrapper">
      <header className="sa_revenue_header">
        <div className="sa_header_text">
          ...
          <p>Global Intelligence Hub • {lastSynced}</p>
        </div>

        <div className="sa_category_nav_main">
          {["Patients", "Appointments", "Doctors"].map((cat) => (
            <button key={cat} className={`sa_nav_tab ${activeCategory === cat ? "active" : ""}`} onClick={() => setActiveCategory(cat)}>
              {cat}
            </button>
          ))}
        </div>
      ...
      <div className="sa_stats_bento">
        {activeCategory === "Patients" && (
          <>
            <div className="sa_stat_card primary"><span className="sa_label">Database Size</span><h2 className="sa_value">{patientsData.length}</h2></div>
            <div className="sa_stat_card"><span className="sa_label">Active Case</span><h2 className="sa_value">542</h2></div>
            <div className="sa_stat_card"><span className="sa_label">Success Rate</span><h2 className="sa_value">98%</h2></div>
            <div className="sa_stat_card highlight"><span className="sa_label">Growth</span><h2 className="sa_value">+12%</h2></div>
            <div className="sa_stat_card"><span className="sa_label">Avg Age</span><h2 className="sa_value">32</h2></div>
          </>
        )}
        {activeCategory === "Appointments" && (
          <>
            <div className="sa_stat_card primary"><span className="sa_label">Total Registry</span><h2 className="sa_value">{appointmentsData.length}</h2></div>
            <div className="sa_stat_card"><span className="sa_label">Done</span><h2 className="sa_value">{appointmentsData.filter(a => a.status === "Completed").length}</h2></div>
            <div className="sa_stat_card"><span className="sa_label">Wait Time</span><h2 className="sa_value">8m</h2></div>
            <div className="sa_stat_card highlight"><span className="sa_label">Conversion</span><h2 className="sa_value">84%</h2></div>
            <div className="sa_stat_card"><span className="sa_label">Emergency</span><h2 className="sa_value">{appointmentsData.filter(a => a.type === "Emergency").length}</h2></div>
          </>
        )}
        {activeCategory === "Doctors" && (
          <>
            <div className="sa_stat_card primary"><div className="sa_pulse_ring"></div><span className="sa_label">Total Staff</span><h2 className="sa_value">{doctorsData.length}</h2></div>
            <div className="sa_stat_card"><span className="sa_label">Available</span><h2 className="sa_value">{doctorsData.filter(d => d.availability === "Available").length}</h2></div>
            <div className="sa_stat_card"><span className="sa_label">Rating</span><h2 className="sa_value">4.9/5</h2></div>
            <div className="sa_stat_card highlight"><span className="sa_label">Depts</span><h2 className="sa_value">12</h2></div>
            <div className="sa_stat_card"><span className="sa_label">Avg Load</span><h2 className="sa_value">10/Day</h2></div>
          </>
        )}
      </div>
      ...
      <div className="sa_category_container">
          ...
          <>
            <div className="sa_bento_row_sync">
              <div className="sa_bento_item span_2">
                <div className="sa_card_head">
                  ...
                  <input type="number" value={patAcqYear} onChange={(e) => setPatAcqYear(e.target.value)} className="sa_calendar_input_v2" style={{width:'90px'}} />
                </div>
            ...
            <div className="sa_bento_row_sync">
              ...
              <div className="sa_bento_item">
                ...
                <button className="sa_view_more_full">Extract Review Logs</button>
              </div>
            </div>
          </>
        )}
        ...
        {activeCategory === "Doctors" && (
          <>
            <div className="sa_bento_row_sync">
              <div className="sa_bento_item span_2">
                <div className="sa_card_head">
                  ...
                  <input type="number" value={docWorkYear} onChange={(e) => setDocWorkYear(e.target.value)} className="sa_calendar_input_v2" style={{width:'90px'}} />
                </div>
                <div className="sa_canvas_holder_reduced">
              ...
              <div className="sa_bento_item">
                <div className="sa_card_head"><h3>Clinical Specialty Matrix</h3></div>
                <div className="sa_patient_center_content">
                  <div className="sa_chart_focus_mini">
            ...
            <div className="sa_bento_row_sync">
              <div className="sa_bento_item">
                <div className="sa_card_head"><h3>Lead Practitioner</h3></div>
                <div className="sa_best_doctor_profile">
                   ...
                   <div className="sa_doc_info_row">
                      <div className="sa_info_box"><span>Specialty</span><strong>{doctorCharts.bestPerformer.dept}</strong></div>
                      <div className="sa_info_box"><span>Cases</span><strong>{doctorCharts.bestPerformer.appointments}</strong></div>
                   </div>
                </div>
              </div>
              <div className="sa_bento_item span_2">
          ...
          <>
            <div className="sa_bento_row_equal"> 
              <div className="sa_bento_item">
                <div className="sa_card_head">
                  <h3>Weekly Volume</h3>
                  <input type="week" value={appVolWeek} onChange={(e) => setAppVolWeek(e.target.value)} className="sa_calendar_input_v2" style={{ minWidth: '150px' }} />
                </div>
                <div className="sa_vol_summary_compact">
                  <span className="sa_vol_label">Week Total: </span>
                  <span className="sa_vol_value_mini">{appointmentCharts.totalWeekly}</span>
                </div>
                <div className="sa_canvas_holder_reduced">
              ...
              <div className="sa_bento_item">
                <div className="sa_card_head">
                  ...
                  <div className="sa_mini_tabs" style={{display:'flex', gap:'8px'}}>
                     <input type="month" value={appPeakMonth} onChange={(e) => setAppPeakMonth(e.target.value)} className="sa_calendar_input_v2" style={{width:'125px'}}/>
                     <div className="sa_mini_tabs">
            ...
            <div className="sa_bento_row_sync">
              <div className="sa_bento_item">
                 <div className="sa_card_head"><h3>Registry Status Mix</h3></div>
                 <div className="sa_canvas_holder_compact">
              ...
              <div className="sa_bento_item span_2">
                 <div className="sa_card_head"><h3>Department Traffic Load</h3></div>
                 <div className="sa_canvas_holder_compact">
                    <Bar 
                      data={{
