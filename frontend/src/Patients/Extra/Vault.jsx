...
import { 
  Folder, FileText, Search, Filter, Download, 
  Share2, Eye, Trash2, ShieldCheck, HardDrive, 
  Clock, Plus, ChevronRight, FileDigit
} from 'lucide-react';
import './Vault.css';
...
export default function Vault() {
  ...
  return (
    <div className="pat_vau_container">
      ...
      {/* LEFT COLUMN: FILE EXPLORER (3 Ratio) */}
      ...
      {/* RIGHT SIDEBAR: STORAGE & STATUS (1 Ratio) */}
