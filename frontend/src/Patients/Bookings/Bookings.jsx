...
import { 
  Calendar, Clock, MoreVertical, XCircle, FileText,
  CheckCircle2, Video, MapPin, Plus, Search, 
  ChevronRight, X, User, MessageSquare, Star
} from 'lucide-react';
...
export default function Bookings() {
  ...
  // New States for Detail Panel and Rescheduling
  ...
  const myBookings = useMemo(() => {
    ...
    // Strictly filter for Arjun Mehta and apply Search/Status filters
        ...
        {selectedAppt ? (
          <div className="detail_panel_content">
            ...
            <div className="detail_scroll_body">
              {/* Conditional View: Reschedule Form vs Details */}
              {isRescheduling ? (
          ...
          <div className="detail_empty_state">
            ...
            <p>Click on any booking to view full details, prescriptions, or manage your schedule.</p>
          </div>
        )}
      </aside>
