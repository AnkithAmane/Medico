...
// Component Import (Ensure path leads to your AppointmentForm component)
...
export default function Specialists() {
  ...
  // Logic: Multi-factor Filtering (Search + Department + Location)
  ...
  // Logic: Trigger Booking Form from Card or Panel
  ...
  return (
    <div className="pat_spec_container_full">
      ...
      {/* --- LEFT SIDE PROFILE PANEL (Full Height) --- */}
